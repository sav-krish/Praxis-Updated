...
export function TourCard({
  ...
  return (
    <div className="praxis-light-surface w-[340px] max-w-[calc(100vw-32px)] rounded-2xl border border-[#d97843] bg-white p-5 shadow-[0_18px_50px_rgba(128,52,20,0.22)]">
      <div className="mb-2 flex items-start justify-between gap-2">
        ...
        {skipTour && (
          <button
            ...
            className="rounded-full p-1 text-muted-text transition-colors hover:bg-[#fff1e5] hover:text-[#4a1f10]"
          >
            <X className="h-4 w-4" />
          </button>
        )}
          ...
          <div className="flex items-center gap-2">
            {!isFirst && (
              <button
                type="button"
                onClick={prevStep}
                className="inline-flex items-center gap-1 rounded-md border border-[#d8a986] bg-white px-2.5 py-2 text-xs font-medium text-[#4a1f10] transition-colors hover:bg-[#fff6ee]"
